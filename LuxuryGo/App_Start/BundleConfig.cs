    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Assets/Frontend/FashionPro").Include(
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.bootstrap.less.css",
                    ...
                    "~/Assets/Frontend/t3-assets/dev/plugins.system.t3.base-bs3.less.t3.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.core.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.typography.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.forms.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.navigation.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.navbar.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.modules.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.joomla.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.components.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.style.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.template.less.css",
                    "~/Assets/Frontend/t3-assets/dev/plugins.system.t3.base-bs3.less.megamenu.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.megamenu.less.css",
                    "~/Assets/Frontend/t3-assets/dev/plugins.system.t3.base-bs3.less.off-canvas.less.css",
                    "~/Assets/Frontend/t3-assets/dev/templates.eshop_fashion_pro.less.off-canvas.less.css",
