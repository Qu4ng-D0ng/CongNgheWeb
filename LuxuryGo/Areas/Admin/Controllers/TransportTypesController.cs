...
namespace LuxuryGo.Areas.Admin.Controllers
{
    public class TransportTypesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            LuxuryGo.Models.Entities.TransportType transportType = db.TransportTypes.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] LuxuryGo.Models.Entities.TransportType transportType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] LuxuryGo.Models.Entities.TransportType transportType)
        {
            if (ModelState.IsValid)
            {
